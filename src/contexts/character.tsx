...
const CharacterContext = createContext<{
  character: Character;
  setCharacter: (newValue: Character) => void;
} | null>(null);

export const CharacterProvider = ({ children }: { children: ReactNode }) => {
  const [character, setCharacter] = useState<Character>(sampleObject);
...
export const useCharacterValue = () => {
  const context = useContext(CharacterContext);
  if (!context) {
    throw new Error("useJsonValue must be used within a JsonValueProvider");
  }
  return context;
};
